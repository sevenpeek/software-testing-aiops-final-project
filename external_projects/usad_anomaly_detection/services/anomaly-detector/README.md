...
这是为第三档目标补充开发的自研微服务。它将 USAD 异常检测能力封装为 HTTP API，可作为 Online Boutique 等微服务系统的智能运维组件接入。
...
```json
{
  "input": "/app/data/prometheus_online_boutique_metrics.csv",
  "out": "/app/outputs",
  "window": 12,
  "epochs": 180
}
...
Invoke-RestMethod -Method Post -Uri http://127.0.0.1:8088/detect `
  -Body '{"input":"data/sample_kpi_metrics.csv","out":"outputs_service"}' `
