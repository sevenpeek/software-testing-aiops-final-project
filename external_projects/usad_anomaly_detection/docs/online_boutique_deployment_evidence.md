...
Online Boutique 已作为复杂开源微服务系统成功部署，包含 frontend、cart、checkout、currency、email、payment、product catalog、recommendation、shipping、ad、redis cart、load generator 等服务。结合本项目新增的 `anomaly-detector` 自研微服务，可以支撑第三档评分中“复杂微服务系统 + 微服务开发”的展示要求。
