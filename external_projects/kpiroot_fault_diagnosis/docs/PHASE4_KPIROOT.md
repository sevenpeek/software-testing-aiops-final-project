...
- 总结 CSV：`data/phase4/kpiroot/summary.csv`
- 消融总结 CSV：`data/phase4/kpiroot/ablation_summary.csv`
- 每个故障场景的输出：
  - `data/phase4/kpiroot/pod-kill-paymentservice-001/ranking.csv`
  - `data/phase4/kpiroot/pod-kill-paymentservice-001/ablation_summary.csv`
  - `data/phase4/kpiroot/pod-kill-paymentservice-001/topk_scores.png`
  - `data/phase4/kpiroot/pod-kill-paymentservice-001/alarm_top_candidates.png`
  - `data/phase4/kpiroot/stress-frontend-cpu-001/ranking.csv`
  - `data/phase4/kpiroot/stress-frontend-cpu-001/ablation_summary.csv`
  - `data/phase4/kpiroot/stress-frontend-cpu-001/topk_scores.png`
  - `data/phase4/kpiroot/stress-frontend-cpu-001/alarm_top_candidates.png`
  - `data/phase4/kpiroot/stress-paymentservice-cpu-001/ranking.csv`
  - `data/phase4/kpiroot/stress-paymentservice-cpu-001/ablation_summary.csv`
  - `data/phase4/kpiroot/stress-paymentservice-cpu-001/topk_scores.png`
  - `data/phase4/kpiroot/stress-paymentservice-cpu-001/alarm_top_candidates.png`
