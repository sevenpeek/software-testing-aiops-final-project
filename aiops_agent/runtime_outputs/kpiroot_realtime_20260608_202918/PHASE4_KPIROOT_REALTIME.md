...
```text
kpiroot_realtime_20260608_202918
```
...
| --- | --- | --- | --- | ---: | --- | --- | --- |
| realtime-paymentservice-cpu | `paymentservice` | `paymentservice` | `memory__productcatalogservice` | 2 | no | yes | yes |
...
| --- | --- | --- | ---: | --- | --- | --- |
| realtime-paymentservice-cpu | `similarity_only` | `memory__productcatalogservice` | 2 | no | yes | yes |
| realtime-paymentservice-cpu | `causality_only` | `memory__currencyservice` | 20 | no | no | no |
| realtime-paymentservice-cpu | `kpiroot_combined` | `memory__productcatalogservice` | 2 | no | yes | yes |

## 输出明细

- 总结 CSV：`kpiroot_realtime_20260608_202918/summary.csv`
- 消融总结 CSV：`kpiroot_realtime_20260608_202918/ablation_summary.csv`
- 每个故障场景的输出：
  - `kpiroot_realtime_20260608_202918/realtime-paymentservice-cpu/ranking.csv`
  - `kpiroot_realtime_20260608_202918/realtime-paymentservice-cpu/ablation_summary.csv`
  - `kpiroot_realtime_20260608_202918/realtime-paymentservice-cpu/topk_scores.png`
  - `kpiroot_realtime_20260608_202918/realtime-paymentservice-cpu/alarm_top_candidates.png`
