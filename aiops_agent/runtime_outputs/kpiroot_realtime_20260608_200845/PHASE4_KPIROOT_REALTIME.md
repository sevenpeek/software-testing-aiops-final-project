...
```text
kpiroot_realtime_20260608_200845
```
...
- 总结 CSV：`kpiroot_realtime_20260608_200845/summary.csv`
- 消融总结 CSV：`kpiroot_realtime_20260608_200845/ablation_summary.csv`
- 每个故障场景的输出：
  - `kpiroot_realtime_20260608_200845/realtime-paymentservice-cpu/ranking.csv`
  - `kpiroot_realtime_20260608_200845/realtime-paymentservice-cpu/ablation_summary.csv`
  - `kpiroot_realtime_20260608_200845/realtime-paymentservice-cpu/topk_scores.png`
  - `kpiroot_realtime_20260608_200845/realtime-paymentservice-cpu/alarm_top_candidates.png`
