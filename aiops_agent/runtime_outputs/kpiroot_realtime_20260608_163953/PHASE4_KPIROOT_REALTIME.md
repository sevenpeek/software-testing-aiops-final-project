...
```text
kpiroot_realtime_20260608_163953
```
...
| realtime-paymentservice-cpu | `causality_only` | `cpu__currencyservice` | 10 | no | no | no |
| realtime-paymentservice-cpu | `kpiroot_combined` | `cpu__paymentservice` | 1 | yes | yes | yes |

## 输出明细

- 总结 CSV：`kpiroot_realtime_20260608_163953/summary.csv`
- 消融总结 CSV：`kpiroot_realtime_20260608_163953/ablation_summary.csv`
- 每个故障场景的输出：
  - `kpiroot_realtime_20260608_163953/realtime-paymentservice-cpu/ranking.csv`
  - `kpiroot_realtime_20260608_163953/realtime-paymentservice-cpu/ablation_summary.csv`
  - `kpiroot_realtime_20260608_163953/realtime-paymentservice-cpu/topk_scores.png`
  - `kpiroot_realtime_20260608_163953/realtime-paymentservice-cpu/alarm_top_candidates.png`
